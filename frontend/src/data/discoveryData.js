export const dashboardData = {
  combined: {
    ...
    answers: {
      ...
      q11: { category: "Convenience", insight: "Users appreciate platforms that save them time and effort, but convenience alone cannot overcome a lack of operational trust.", dataProof: "Convenience is cited as a primary driver in 6.8% of reviews, often associated with Habitual Buyers.", voice: "best shopping for rakhi great deal more beautiful rakhi online delivery at time I have save my time and money." },
      q12: { category: "Price Sensitivity", insight: "While discounts and gift cards attract Deal Seekers, hidden charges or unapplied coupons at checkout lead to immediate cart abandonment.", dataProof: "Price Sensitivity drives 4.5% of decisions, primarily isolated to the Deal Seeker segment.", voice: "even after applying gift cart they are charging 49rs more?" },
      q13: { category: "Missing Feature", insight: "Users often abandon the app if basic utility features (like specific payment methods, UI fixes, or proper filtering) are broken or unavailable.", dataProof: "Missing Feature drives 3.2% of signals, highlighting technical roadblocks in the purchase journey.", voice: "App crashes every time I try to filter by size." },
      q14: { category: "Past Experience", insight: "A single negative past experience severely damages brand loyalty, causing users to passively wishlist items without real intent to buy.", dataProof: "Past Experience accounts for 2.3% of decisions, acting as a direct filter on future intent.", voice: "I had a bad experience last year so I'm hesitant to buy expensive items here." },
      q15: { category: "Competitor Superiority", insight: "When facing delivery or return friction, users readily abandon their cart for competitors who offer faster, guaranteed fulfillment.", dataProof: "Competitor Superiority accounts for 1.4% of decisions, almost entirely manifesting as Cart Abandonment.", voice: "AJIO delivers in 2 days, I'll just order it there." },
      q16: { category: "Visual Appeal", insight: "While aesthetics initially draw users to add items to their wishlist, the visual appeal is quickly overshadowed by delivery concerns.", dataProof: "Visual Appeal is the initial hook, but only represents 0.9% of final decision drivers for Play Store users.", voice: "it's always a joyful experience to add anything to the cart at Myntra." },
      q17: { category: "Quality Uncertainty", insight: "Users hesitate to purchase when they cannot validate the fabric or quality, often abandoning the cart or searching for external video reviews.", dataProof: "Quality Uncertainty drives 0.9% of Play Store decisions, but is a massive factor for YouTube users.", voice: "Not sure if the fabric will be itchy." }
    },
    rawQuotes: [
  ...
  playstore: {
    ...
    answers: {
      ...
      q11: { category: "Convenience", insight: "Play Store users value seamless interfaces and quick ordering, but convenience is completely nullified if the delivery fails.", dataProof: "Convenience is cited in 6.8% of reviews.", voice: "best shopping for rakhi great deal more beautiful rakhi online delivery at time I have save my time and money." },
      q12: { category: "Price Sensitivity", insight: "Deal Seekers on the Play Store are highly sensitive to hidden delivery fees added at checkout.", dataProof: "Price Sensitivity is 4.5% of the data.", voice: "even after applying gift cart they are charging 49rs more?" },
      q13: { category: "Missing Feature", insight: "Technical glitches and missing UX features directly cause cart abandonment.", dataProof: "Missing Feature accounts for 3.2% of Play Store signals.", voice: "App crashes every time I try to filter by size." },
      q14: { category: "Past Experience", insight: "Play Store users hold grudges. A previous bad delivery ensures future items stay in the wishlist permanently.", dataProof: "Past Experience is 2.3% of the dataset.", voice: "I had a bad experience last year so I'm hesitant to buy expensive items here." },
      q15: { category: "Competitor Superiority", insight: "Play Store users actively compare Myntra's delivery times against faster competitors and abandon carts if the competitor wins.", dataProof: "Competitor Superiority is 1.4% of the dataset.", voice: "AJIO delivers in 2 days, I'll just order it there." },
      q16: { category: "Visual Appeal", insight: "Play Store users enjoy the visual aesthetics of the catalog, using it for inspiration, but it rarely drives the final purchase decision on its own.", dataProof: "Visual Appeal is 0.9% of the dataset.", voice: "it's always a joyful experience to add anything to the cart at Myntra." },
      q17: { category: "Quality Uncertainty", insight: "Without physical touch, Play Store users express doubt about material quality, though it is a smaller concern compared to delivery anxiety.", dataProof: "Quality Uncertainty is 0.9% of Play Store signals.", voice: "Not sure if the fabric will be itchy." }
    },
    rawQuotes: [
      { text: "I returned the products and the app showed that the refund has been processed, but I still haven't received the money in my account.", category: "Trust Deficit", source: "playstore", segment: "Trust-Gated Shopper", evidence: "Return Anxiety" },
...
export const questionTitles = [
  ...
  { key: 'q11', title: "How does convenience factor into the purchase journey?" },
  { key: 'q12', title: "How sensitive are users to pricing and hidden fees?" },
  { key: 'q13', title: "What app features are users explicitly asking for?" },
  { key: 'q14', title: "How do past experiences impact current wishlist behavior?" },
  { key: 'q15', title: "What causes a user to abandon for a competitor?" },
  { key: 'q16', title: "How does the visual appeal of an item influence discovery?" },
  { key: 'q17', title: "How do users resolve uncertainty about product quality?" }
];
