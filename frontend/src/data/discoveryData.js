export const dashboardData = {
  combined: {
    ...
    answers: {
      ...
      q3: { category: "Quality Uncertainty", insight: "Even after deciding they want a product, users face sizing and fit uncertainty. A poor fit upon arrival leads directly to negative reviews and sizing complaints.", dataProof: "Quality Uncertainty drives cart abandonment and negative sizing feedback.", voice: "This top is very bad because this was very tight" },
      q4: { category: "Missing Feature", insight: "Technical glitches and slow search performance act as immediate roadblocks, causing users to abandon the app before they can even view their wishlisted products.", dataProof: "Missing Feature accounts for 3.2% of signals.", voice: "app is extremely slow , it takes forever to search something and then lands on oops something went wrong" },
      q5: { category: "Competitor Superiority", insight: "Users compare products not just on design, but by evaluating if competitors like Flipkart offer the exact same product at a cheaper price.", dataProof: "Competitor Superiority accounts for 1.4% of decisions, acting as an immediate trigger to leave the app.", voice: "it is very nice but same products you can buy from flipcart too in less prise" },
      q6: { category: "Visual Appeal", insight: "While visual aesthetics initially draw users to wishlist an item, they seek external video validation (like YouTube) to confirm the visual reality gap.", dataProof: "Visual Appeal represents the initial hook, but users need external proof to convert.", voice: "it's always a joyful experience to add anything to the cart at Myntra." },
      ...
      q8: { category: "Past Experience", insight: "Positive past experiences and reliable on-time deliveries build strong brand loyalty, turning casual browsers into Habitual Buyers who return for specific events.", dataProof: "Past Experience accounts for 2.3% of decisions and drives Repeat Purchases.", voice: "best shopping for rakhi great deal more beautiful rakhi online delivery at time I have save my time and money. I always purchased rakhi on that platform" },
      q9: { category: "Convenience", insight: "Habitual Buyers prioritize seamless interfaces and express delivery options. True convenience during emergencies solidifies platform loyalty.", dataProof: "Convenience is cited as a primary driver in 6.8% of reviews.", voice: "best app to buy beautiful clothes with same day delivery by myntra minutes... saved me during emergency" },
    ...
    rawQuotes: [
      ...
      { text: "best app to buy beautiful clothes with same day delivery by myntra minutes and express delivery had an amazing experiences. saved me during emergency", category: "Convenience", source: "playstore", segment: "Habitual Buyer", evidence: "Not Mentioned" },
  ...
  playstore: {
    ...
    answers: {
      ...
      q3: { category: "Quality Uncertainty", insight: "Even after deciding they want a product, users face sizing and fit uncertainty. A poor fit upon arrival leads directly to negative reviews and sizing complaints.", dataProof: "Quality Uncertainty is 0.9% of Play Store signals.", voice: "This top is very bad because this was very tight" },
      q4: { category: "Missing Feature", insight: "Technical glitches and slow search performance act as immediate roadblocks, causing users to abandon the app before they can even view their wishlisted products.", dataProof: "Missing Feature accounts for 3.2% of Play Store signals.", voice: "app is extremely slow , it takes forever to search something and then lands on oops something went wrong" },
      q5: { category: "Competitor Superiority", insight: "Users compare products not just on design, but by evaluating if competitors like Flipkart offer the exact same product at a cheaper price.", dataProof: "Competitor Superiority is 1.4% of the dataset.", voice: "it is very nice but same products you can buy from flipcart too in less prise" },
      q6: { category: "Visual Appeal", insight: "Users enjoy the visual aesthetics of the catalog, using it for inspiration and as a joyful experience when adding items to the cart.", dataProof: "Visual Appeal is 0.9% of the dataset.", voice: "it's always a joyful experience to add anything to the cart at Myntra." },
      ...
      q8: { category: "Past Experience", insight: "Positive past experiences and reliable on-time deliveries build strong brand loyalty, turning casual browsers into Habitual Buyers who return for specific events.", dataProof: "Past Experience is 2.3% of the dataset.", voice: "best shopping for rakhi great deal more beautiful rakhi online delivery at time I have save my time and money. I always purchased rakhi on that platform" },
      q9: { category: "Convenience", insight: "Habitual Buyers prioritize seamless interfaces and express delivery options. True convenience during emergencies solidifies platform loyalty.", dataProof: "Convenience is cited in 6.8% of reviews.", voice: "best app to buy beautiful clothes with same day delivery by myntra minutes... saved me during emergency" },
