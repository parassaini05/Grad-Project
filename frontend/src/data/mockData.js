export const INSIGHTS_DATA = [
  {
    ...
    proof: "59.7% of analyzed reviews cited Trust Deficit as the primary decision driver. 68.8% of users are 'Trust-Gated Shoppers'.",
  ...
  },
  {
    ...
    proof: "54.3% of evidence types were Delivery Complaints.",
  ...
  },
  {
    ...
    proof: "13.6% cited Delivery Anxiety. Return Anxiety accounted for 6.3%.",
  ...
  },
  {
    ...
    proof: "Delivery Complaint was the single largest evidence type at 54.3%.",
  ...
  },
  {
    ...
    proof: "Trust Deficit (59.7%) dominates over Price Sensitivity (4.5%) by a ratio of roughly 13:1.",
  ...
  },
  {
    ...
    proof: "Trust-Gated Shoppers (68.8%) vastly outnumber Fit-Anxious Shoppers.",
  ...
  },
  {
    ...
    proof: "1.8% of evidence was Repeat Purchase, while the majority was complaint-driven.",
  ...
  },
  {
    ...
    insight: "The overwhelming majority (68.8%) of analyzed users fall into the 'Trust-Gated Shopper' segment. Deal Seekers (6.3%) exist but are a much smaller segment.",
  ...
  },
  {
    ...
    proof: "These needs map to Delivery Complaint (54.3%), Return Anxiety (6.3%), and Trust Deficit (59.7%).",
...
export const GRAPH_DATA = {
  combined: [
    { label: "Trust Deficit", value: 59.7 },
    { label: "Delivery Anxiety", value: 13.6 },
    { label: "Price Sensitivity", value: 4.5 }
  ],
  playstore: [
    { label: "Trust Deficit", value: 59.7 },
    { label: "Delivery Anxiety", value: 13.6 },
